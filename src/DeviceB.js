...
const green= '#008000';
const dates='Date';
const matter='Particulate Matter10'
const deva='Device A';
const devb='Device B';
const devc='Device C';
class DeviceB extends Component{
  ...
  yAxis = d3.axisLeft().scale(this.yScale)
    .tickFormat(d => `${d}`);
      ...
      componentWillReceiveProps(nextProps){//will get data from parent component.
          ...
          //generates the line for PM10 value for the deviceA
          this.lineGenerator.y(d=>this.yScale(d.p10));
          const lows=this.lineGenerator(matter1);
          //generates the line for PM10 value for the deviceB
          this.lineGenerator.y(d=>this.yScale(d.p10));
          const mids=this.lineGenerator(matter2);
          //generates the line for PM10 value for the deviceC
